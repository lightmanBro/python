...
def make_periodic_table():
    ...
    # obj = {}
    # sym = periodic_table[0]
    # elName = periodic_table[1]
    # elValue = periodic_table[2]
    # obj[sym] = [elName, elValue]
    # print(obj)
...
def get_formula_name(formula, known_molecules_dict):
    ...
    for item in known_molecules_dict.items():
        key = item[0]
...
def main():
    ...
    formula = input("Please inout a chemical formula for a molecule: ").upper()

    # Get the mass of a chemical sample in grams from the user.
    mass = float(input("Please imput the mass of a chemical sample in grams: "))

    # Call the make_periodic_table function and
    # store the periodic table in a variable.
    periodic_table = make_periodic_table()

    # Call make_molecules_dict and
    # store it in a variable
    known_molecules_dict = make_molecules_dict()

    # Call the get_formula_name function and 
    # store it in a variable
    ...
    gramole = compute_molar_mass(compound, periodic_table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for item in symbol_quantity_list:
        ...
        info = periodic_table_dict[symbol]

        mass = info[ATOMIC_MASS_INDEX]

        total += round(mass * quantity, 5)
