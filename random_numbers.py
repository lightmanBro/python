...
#     def append_random_numbers(number_lists, quantity = 1):
#         for _ in range(quantity):
#             random_number = random.uniform(0, 100)
#             rounded = round(random_number, 1)
#             number_lists.append(rounded)
...
def append_random_words(words_list, quantity=1):
    ...
    candidates = [
        "arm", "car", "cloud", "head", "heal", "hydrogen", "jog", "join",
        "laugh", "love", "sleep", "smile", "speak", "sunshine", "toothbrush",
